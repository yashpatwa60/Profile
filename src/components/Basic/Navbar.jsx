...
const Navbar = () => {
  return (
    <div className="py-2 bg-blue-500 text-white flex flex-wrap justify-center items-center gap-10">
      <div>
       <Link to="/"> <img className="h-6 w-15" src={Flip} /></Link>
        <p>Explore <span className="text-yellow-300">Plus</span></p>
      </div>
      <div>
        <input className="max-w-[400px] h-[30px] focus:ring-0 p-2" placeholder='Search for Produts, brands and more'/>
      </div>
